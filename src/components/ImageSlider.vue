<template>
    <div id="slider">
      ...
      <div id="slides">
        <div id="overflow">
          <div class="inner">
            <article>
              <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/5689/rock.jpg" alt="Slide 1">
            </article>
            <article>
              <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/5689/grooves.jpg" alt="Slide 2">
            </article>
            <article>
              <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/5689/arch.jpg" alt="Slide 3">
            </article>
            <article>
              <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/5689/sunset.jpg" alt="Slide 4">
            </article>
          </div> <!-- .inner -->
        </div> <!-- #overflow -->
      </div>
  
      <!-- Navigation labels for slider -->
  ...
  export default {
    ...
    beforeDestroy() {
      clearInterval(this.autoSlideInterval); // Clear interval when component is destroyed
    }
  }
  </script>
